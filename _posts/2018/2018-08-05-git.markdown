...
`vcstool` is a tool developed by the ROS community to manage multiple VCS repos (git, etc.). vcs works by finding a `.repos` which lists all repos to clone.
